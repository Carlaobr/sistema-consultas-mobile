...
export type FiltroOpcao = "Todas" | StatusConsulta;
...
const opcoes: FiltroOpcao[] = ["Todas", "Agendada", "Confirmada", "Pendente", "Cancelada"];
  ...
  return (
    ...
    >
      {opcoes.map((opcao) => (
        ...
        >
          <Text style={[styles.texto, filtroAtivo === opcao && styles.textoAtivo]}>
            {opcao}
          </Text>
          <View style={[styles.badge, filtroAtivo === opcao && styles.badgeAtivo]}>
            <Text style={[styles.badgeTexto, filtroAtivo === opcao && styles.badgeTextoAtivo]}>
              {contagens[opcao]}
            </Text>
          </View>
        </TouchableOpacity>
